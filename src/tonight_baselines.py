...
SUMMARY_CSV = utils.LOGS_DIR / "tonight_summary.csv"
...
def run_cfg(cfg, device, log) -> dict:
    result_path = utils.LOGS_DIR / f"tonight_{cfg['name']}_result.json"
    ...
    best_meta, best_epoch, elapsed, _ = fit_two_phase(
        ...
        history_csv=utils.LOGS_DIR / f"tonight_{cfg['name']}_history.csv",
